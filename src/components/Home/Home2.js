...
import myImg from "../../Assets/harsh.jpg";
        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              Hello, I'm Harsh Batra, a second-year student at The LNM
              Institute of Information Technology in Jaipur.
              ...
              and back-end technologies. I pride myself on
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/Codepunk20072"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/harsh-batra-3010841b2/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://codeforces.com/profile/harsh62442"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
